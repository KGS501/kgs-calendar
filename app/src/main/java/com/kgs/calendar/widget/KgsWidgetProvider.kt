...
private const val WIDGET_MONTH_DOTS_PER_ROW = 5
...
internal enum class WidgetSizeBucket(
    ...
    Compact(SizeF(260f, 350f), R.layout.widget_month_cell_dynamic, WIDGET_MONTH_MAX_TEXT_LANES, 0, 6, 15f, 8.5f, 10f, 9f),
    Standard(SizeF(300f, 390f), R.layout.widget_month_cell_dynamic, WIDGET_MONTH_MAX_TEXT_LANES, 0, 6, 15f, 8.5f, 10f, 9f),
    Comfortable(SizeF(320f, 470f), R.layout.widget_month_cell_dynamic, WIDGET_MONTH_MAX_TEXT_LANES, 0, 6, 15f, 8.5f, 10f, 9f),
    Expanded(SizeF(360f, 560f), R.layout.widget_month_cell_dynamic, WIDGET_MONTH_MAX_TEXT_LANES, 0, 6, 15f, 8.5f, 10f, 9f),
    Max(SizeF(360f, 680f), R.layout.widget_month_cell_dynamic, WIDGET_MONTH_MAX_TEXT_LANES, 0, 6, 15f, 8.5f, 10f, 9f);
...
internal data class WidgetMonthRenderSpec(
    ...
    val usesDotCells: Boolean get() = bucket.usesDotCells || weekCellHeightDp < WIDGET_MONTH_MIN_TEXT_CELL_HEIGHT_DP || textRowsThatFit() <= 0
    ...
    fun showMiniOverflow(hiddenItemCount: Int): Boolean =
        hiddenItemCount > 0

    fun showTextOverflow(textItemCapacity: Int): Boolean =
        textItemCapacity > 0
    ...
    companion object {
        fun from(size: WidgetSize, rowCount: Int): WidgetMonthRenderSpec {
            ...
            return WidgetMonthRenderSpec(
                ...
                cellContentWidthDp = (weekContentWidth / 7f - WIDGET_MONTH_CELL_HORIZONTAL_MARGIN_DP).coerceAtLeast(0f),
...
internal fun List<WidgetMonthCellContent>.monthBottomFadeSegments(textItemCapacity: Int): List<WidgetMonthWeekSegment> {
